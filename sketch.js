...
function setup() {
 ...
 inv = createSprite(200,0,400,10)
 inv.visible=false

 inv2 = createSprite(200,400,400,10)
 inv2.visible=false
...
function spawn() {
        if (frameCount % 100 === 0) {
          ...
          if (rand === 1) {
            fish1 = createSprite(430,380)
                         fish1.addImage("boss1", fish1img);
              fish1.lifetime = 420;
              fish1.velocityX  = -1;
              fish1.scale=0.1
              fish1.y=random(20,380) 
          ...
          if (rand === 2) {
            fish2 = createSprite(430,310);
            fish2.addImage("boss2", fish2img)
                 fish2.lifetime = 420;
              fish2.velocityX = -1;
              fish2.scale = 0.1
              fish2.y=random(20,380)  
          ...
          if (rand === 3) {
                fish3 = createSprite(430,240);
                fish3.addImage("boss3", fish3img)
                     fish3.lifetime = 420;
                  fish3.velocityX = -1;
                  fish3.scale = 0.1
                  fish3.y=random(20,380) 
                         
                  fishGroup.add(fish3);
              }   
              if (rand === 4) {
                fish4 = createSprite(430,110);
                fish4.addImage("boss4", fish4img)
                     fish4.lifetime = 420;
                  fish4.velocityX = -1;
                  fish4.scale = 0.01
                  fish4.y=random(20,380) 
...
function spawnplastic() {
        if (frameCount % 40 === 0) {
          ...
          if (rand === 1) {
            bag1 = createSprite(430,380)
                         bag1.addImage("bag1", bag1img);
              bag1.lifetime = 420;
              bag1.velocityX  = -1;
              bag1.scale=0.01
              bag1.y=random(20,380) 
              plasticGroup.add(bag1); 
          }
          
          if (rand === 2) {
            bag2 = createSprite(430,310);
            bag2.addImage("bag2", bag2img)
                 bag2.lifetime = 420;
              bag2.velocityX = -1;
              bag2.scale = 0.1
              bag2.y=random(20,380)  
          ...
          if (rand === 3) {
                bottle = createSprite(430,240);
                bottle.addImage("bottle", bottleimg)
                     bottle.lifetime = 420;
                  bottle.velocityX = -1;
                  bottle.scale = 0.1
                  bottle.y=random(20,380)
